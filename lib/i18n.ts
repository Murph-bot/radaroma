...
const el: Strings = {
  ...
  explorer: {
    heading: "Κατάταξε με βάση ό,τι σε νοιάζει",
    reset: "Επαναφορά",
    ...
    empty: "Κανένα καφέ δεν ταιριάζει με αυτά τα φίλτρα.",
  },
  card: {
    match: "ταίριασμα",
    community: "υποβολή κοινότητας · έλεγχος AI",
  },
  cafesPage: {
    title: "Καφέ",
  ...
  detail: {
    ...
    askSub: (name: string) => `Ερωτήσεις για ${name}; Ο concierge ξέρει το προφίλ του.`,
    askPlaceholder: (name: string) => `Ρώτησε για ${name}…`,
  },
  compare: {
    title: "Σύγκριση",
    sub: "Επικάλυψε έως και τρία καφέ σε ένα ραντάρ.",
    pick: (n: number, max: number) => `Διάλεξε 2–3 καφέ (${n}/${max})`,
    hint: "Ο σύνδεσμος ενημερώνεται όσο διαλέγεις — μοιράσου τον για να δείξεις την επικάλυψη.",
    copied: "Αντιγράφηκε",
    copyLink: "Αντίγραφη συνδέσμου",
    axis: "Άξονας",
    average: "Μέσος όρος",
  ...
  submit: {
    title: "Πρότεινε καφέ",
    intro:
      "Ξέρεις ένα μέρος που του αξίζει να είναι εδώ; Στείλ' το και ο concierge θα επιβεβαιώσει ότι το καφέ υπάρχει, θα ψάξει για διπλότυπα και θα συντάξει το προφίλ του. Τίποτα δεν δημοσιεύεται χωρίς επιβεβαίωση — οι προτάσεις της κοινότητας παίρνουν σήμανση, για να ξέρεις ότι δεν είναι δική μας επιλογή.",
    ...
    noteLabel: "Κάτι που πρέπει να ξέρει ο concierge;",
    optional: "(προαιρετικό)",
    notePlaceholder: "Ωραίο φίλτρο, όμορφη αυλή…",
    honeypot: "Άφησε αυτό το πεδίο άδειο",
    submit: "Υποβολή για επιβεβαίωση",
    submitting: "Επιβεβαίωση μέσω concierge…",
    submittingNote:
      "Ο concierge ψάχνει στο διαδίκτυο, κοιτάζει για διπλότυπα και συντάσσει εγγραφή. Συνήθως 10–30 δευτερόλεπτα — κράτησε την καρτέλα ανοιχτή.",
    verifiedTitle: "Επιβεβαιώθηκε — καλώς ήρθε στη λίστα!",
    verifiedBody:
      "Ο concierge επιβεβαίωσε ότι το καφέ υπάρχει και δεν έχει διπλότυπο στον κατάλογο.",
    verifiedCta: "Δες το στη λίστα των καφέ →",
    flaggedTitle: "Στάλθηκε για ανθρώπινο έλεγχο",
    rejectedTitle: "Δεν προστέθηκε αυτή τη φορά",
    flaggedBody:
      "Ο concierge δεν μπόρεσε να επιβεβαιώσει πλήρως αυτό το καφέ (ή ίσως διπλασιάζει κάποιο που έχουμε ήδη). Θα το δει ένας επιμελητής.",
    rejectedBody:
      "Ο concierge δεν μπόρεσε να επιβεβαιώσει ότι αυτό το καφέ υπάρχει. Αν υπάρχει, έλεγξε ξανά το όνομα και τη διεύθυνση και ξαναδοκίμασε.",
  ...
  concierge: {
    ...
    stripSummary: "Ρώτα τον concierge — προτείνει μόνο καφέ του καταλόγου μας",
    placeholder: "Ρώτα τον concierge — π.χ. «ήσυχο μέρος για δουλειά κοντά στα Εξάρχεια;»",
    empty:
      "Ρώτησε για τον καλύτερο εσπρέσο, μια ήσυχη γωνιά για δουλειά, ή ποιο καφέ ταιριάζει στον προϋπολογισμό σου.",
    thinking: "Σκέφτεται…",
    send: "Αποστολή",
    inputAria: "Μήνυμα στον concierge",
    disclaimer:
  ...
  moods: {
    laptopDay: "Για λάπτοπ",
    talk: "Για κουβέντα",
    filterNerd: "Nerd φίλτρου",
    goodCheap: "Καλό & φτηνό",
  },
  bestFor: {
  ...
  meta: {
    siteTitle: "Radaroma",
    siteDescription:
      "Τα καφέ της Αττικής, σε σχήμα. Ραντάρ πέντε αξόνων, κατάταξη που τη στερώνεις εσύ με βάρη, και ένας concierge που ξέρει μόνο τα καφέ του καταλόγου.",
    ogDescription:
      "Τα καφέ της Αττικής, σε σχήμα. Ραντάρ, σταθμισμένη κατάταξη και concierge με AI πάνω στον κατάλογο.",
    twitterDescription: "Τα καφέ της Αττικής, σε σχήμα.",
    cafes: {
      title: "Καφέ",
      description: "Όλα τα επιμελημένα καφέ της Αττικής, καταταγμένα με βάση αυτό που σε νοιάζει.",
    },
    compare: {
      title: "Σύγκριση",
      description: "Επικάλυψε 2–3 καφέ και σύγκρινε τα ραντάρ τους δίπλα-δίπλα.",
    },
    submit: {
      title: "Πρότεινε καφέ",
      description:
        "Λείπει ένα ωραίο καφέ της Αττικής; Πρότεινέ το — ένας AI concierge επιβεβαιώνει ότι υπάρχει και ελέγχει για διπλότυπα πριν δημοσιευτεί.",
    },
  },
}
